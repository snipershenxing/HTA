const Dialogue = {
  ...
  SharrelPhone: {
    ...
    3: {
      text: "Good Morning Mrs. Letkin, this is (PlayerName) from the Aquarium. I hope you remember our conversation at (CDEventHere); is it possible to discuss your interest in our organization?",
      nextDialogue: 6,
      addScore: 3,
    },
    4: {
